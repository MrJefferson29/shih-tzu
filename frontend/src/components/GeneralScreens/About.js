...
import br1 from "../../Assets/arch1.webp";
import br2 from "../../Assets/bolton1.webp";
import ma1 from "../../Assets/bishop1.webp";
    ...
    <Container>
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            At Shih Tzu Excellence, we specialize in breeding and selling
            top-quality pupps to loving families. With over
            a decade of experience, we take pride in the ethical and careful
            breeding of Shih Tzus, ensuring that each pup is healthy,
      ...
      <AdBanner>
        <h2>Want to Meet Our  Shih Tzus?</h2>
        <p>
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            At  Shih Tzu Excellence, we are highly selective about the homes we
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            ...
            well-being of every dog we breed. As dedicated Shih tzu lovers, we
      ...
      <Footer>
        <p>&copy; 2024 Shih Tzu Excellence. All rights reserved.</p>
      </Footer>
    </Container>
  );
};
